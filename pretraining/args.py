...
def conf():
    ...
    parser.add_argument("--numof_classes", default=5, type = int, help="num of classes")
    parser.add_argument("--num_samples", default=50000, type = int, help="number of samples for on-the-fly generation")
